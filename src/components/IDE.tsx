          ...
          {pswPanelOpen && (
            <div className="pswHelpPanel">
              ...
              <div className="pswHelpPanelGrid">
                ...
                <div><strong>run_gap</strong>: {pswOutput.metrics.last_run_ts && pswOutput.metrics.last_activity_ts ? Math.max(0, (pswOutput.metrics.last_activity_ts - pswOutput.metrics.last_run_ts) / 1000).toFixed(1) : "null"}s</div>
